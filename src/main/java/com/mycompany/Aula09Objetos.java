...
public class Aula09Objetos {
   ...
   public static void main(String[] args) {
    /*
     * Em java, toda classe ou tipo abstrato é um objeto, pois possuem características e funcionalidades.
     * 
     * Eles herdam funções da classe mãe java.lang.Object, é correto afirmar que java.Object é uma suoer classe de qualquer outra classe ou tipo abstrato.
     */
   ...
   public static class Carro {
      ...
      void parar() {
         System.out.println("O veículo parou !! e percurreu um total de " + this.quilometragem + "km");
      }
   }
}
